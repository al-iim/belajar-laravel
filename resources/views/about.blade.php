                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://non-pnbp.um.ac.id/"
                                    class="underline text-gray-900 dark:text-white">Seksi Anggaran dan Perpajakan</a>
                            </div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                Aplikasi ini dibangun pada tanggal 13 Mei 2022
                            </div>
                        </div>
                    </div>
                </div>
